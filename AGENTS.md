...
**Project:** `dbg`
**Primary goal:** Lightweight debug logging for embedded systems with RAM-based circular buffer and JTAG inspection.
...
- `meson setup` generates the optional `dbg_version.h` into the **build directory**
